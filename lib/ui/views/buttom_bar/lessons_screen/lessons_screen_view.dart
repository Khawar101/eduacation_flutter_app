...
class LessonsScreenView extends StatefulWidget {
  const LessonsScreenView({Key? key}) : super(key: key);

  @override
  State<LessonsScreenView> createState() => _LessonsScreenViewState();
}

class _LessonsScreenViewState extends State<LessonsScreenView> {
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<LessonsScreenViewModel>.reactive(
      viewModelBuilder: () => LessonsScreenViewModel(),
      builder: (BuildContext context, LessonsScreenViewModel viewModel,
          Widget? child) {
        return Scaffold(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Center(
                                    child: CustomText(
                                  text:
                                      LessonsScreenViewModel.itemsnames[index],
                                  color: Colors.white,
                                  size: 13,
